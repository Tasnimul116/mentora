...
interface FormData {
  ...
  additionalFiles?: string[]; // This will store file URLs/paths after upload
...
export default function CreateLessonPage() {
  ...
  const [selectedPrerequisite, setSelectedPrerequisite] =
    useState<LessonOption | null>(null); // Updated type to hold object or null
              ...
              <div className="space-y-4">
                ...
                {/* <div>
                  ...
                  <Select
                    ...
                    onChange={(option) =>
                      setSelectedPrerequisite(option as LessonOption)
                    }
                    ...
                    styles={selectStyles}
                    className="text-sm"
                    noOptionsMessage={() => 'No lessons found'}
                  />
                  <p className="mt-1.5 text-[10px] leading-tight text-gray-500">
                    Students must complete this lesson before accessing the
                    current one.
                  </p>
                </div>
